 ...
 * traz mais odd/EV prontos (isso mudou na v3.0), então publicar o pick direto
 * sem passar por aqui gera odd/EV undefined no card. Se você já rodou
 * /api/scanner/analisar separadamente pra esse pick e só quer publicar o
 * resultado pronto, mande "resultado_pronto" no body (mesmo shape que
 * analisarPickRadar devolve) pra pular a análise de novo.
 *
 * NOTA DE MANUTENÇÃO (2026): este arquivo é o único que deve responder por
 * essa rota. Existiam duas versões conflitantes -- uma aqui (desatualizada,
 * assumia odd/EV já prontos) e outra órfã em api/scanner/publicar.js (lógica
 * certa, mas fora do vercel.json e com require quebrado apontando pra pasta
 * errada). Foram unificadas nesta única versão; o arquivo órfão foi removido.
 *
 * Body esperado:
 * {
